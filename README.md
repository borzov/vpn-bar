...
**Примечание:** Приложение подписано ad-hoc подписью для предотвращения карантина macOS. Если все же появится сообщение о повреждении приложения, выполните в Терминале:
