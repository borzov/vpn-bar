...
**Улучшения интерфейса и локализации**

#### Добавлено
- Вкладка "О программе" в настройках с информацией о приложении, версии, авторе и ссылкой на репозиторий
- Поддержка китайской локали (упрощенный китайский, zh-Hans)
- Улучшенный интерфейс записи горячих клавиш:
  - Визуальное отображение модификаторов с системными глифами (⌘ ⇧ ⌥ ⌃)
  - Inline валидация с отображением ошибок под кнопкой
  - Кнопка очистки горячей клавиши
- Краткое описание приложения на трех языках в окне "О программе"

#### Исправлено
- Уменьшены отступы в окне настроек для более компактного отображения
- Исправлено позиционирование контекстного меню (правый клик) — теперь всегда прижато к строке меню
- Все пользовательские строки вынесены в файлы локализации (включая описания и сообщения об ошибках)
- Улучшена консистентность текстов в интерфейсе

#### Технические улучшения
- Полная локализация всех пользовательских сообщений и описаний
- Поддержка трех языков: русский, английский, китайский (упрощенный)
- Оптимизированная структура файлов локализации с группировкой по функциональности

### Version 0.3.0 (2025-11-27)
